      ...
      <tr>
        ...
        @endphp
          <td class="text-center align-middle">
            <a href="/edit/{{ $game->id }}" class="btn btn-info">{{ __('odds.admin_edit') }}</a>
            <a href="/close/{{ $game->id }}" class="btn btn-info">{{ __('odds.admin_close') }}</a>
            <a href="/result/{{ $game->id }}" class="btn btn-info">{{ __('odds.admin_result') }}</a>
          </td>
        @php
        }
        @endphp
