    ...
    if( elem )
    {
      if( bets[i].type == 0 )
      {
        ...
        if( can0 != null )
        {
          elem.innerHTML = '<table>'
                         +   '<tr>'
                         +     '<td class="border border-dark fw-bold" rowspan="4"><div class="odds_vertical_rect">{{ __("odds.bet_win") }}</div></td>'
                         +     '<td colspan="3"></td>'
                         +   '</tr>'
                         +   '<tr>'
                         +     '<td></td>'
                         +     '<td class="border border-dark fw-bold text-center">' + (can0.disp_order+1) + '</td>'
                         +     '<td class="fw-bold">' + can0.name + '</td>'
                         +   '</tr>'
                         +   '<tr>'
                         +     '<td>　</td>'
                         +     '<td>　</td>'
      ...
      else if( bets[i].type == 1 )
      {
        ...
        if( can0 != null && can1 != null )
        {
          ...
          elem.innerHTML = '<table>'
                         +   '<tr>'
                         +     '<td class="border border-dark fw-bold" rowspan="4"><div class="odds_vertical_rect">{{ __("odds.bet_quinella") }}</div></td>'
                         +     '<td colspan="3"></td>'
                         +   '</tr>'
                         +   '<tr>'
                         +     '<td>　</td>'
      ...
      else if( bets[i].type == 2 )
      {
        ...
        if( can0 != null && can1 != null )
        {
          elem.innerHTML = '<table>'
                         +   '<tr>'
                         +     '<td class="border border-dark fw-bold" rowspan="4"><div class="odds_vertical_rect">{{ __("odds.bet_exacta") }}</div></td>'
                         +     '<td colspan="3"></td>'
                         +   '</tr>'
                         +   '<tr>'
                         +     '<td>　</td>'
