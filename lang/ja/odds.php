...
return [
	...
	'info_about' => 'このサイトは、開催される予定のレースに仲間うちで勝手なオッズをつけ予想しようというサイトです。<br>あくまでも「お遊び」です。課金要素は一切ありません。得られたポイントは次回別のレースへ持ち越せるという以外に用途はありません。<br><br>参加するだけなら特にユーザ登録の必要はありません。そのままレースを選んで予想してください。<br>レースを新規に登録する場合にはユーザ登録(無料)が必要になります。',
