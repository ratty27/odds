...
return [
	...
	'info_about_desc' => 'このサイトは、開催される予定のレースに仲間うちで勝手なオッズをつけ予想しようというサイトです。<br>あくまでも「お遊び」です。課金要素は一切ありません。得られたポイントは次回別のレースへ持ち越せるという以外に用途はありません。<br><b>なお、賭けるポイントがなくなってしまった場合は右上の歯車ボタンからいつでも所持ポイントを 30000pt にリセットできます。</b><br><br>参加するだけなら特にユーザ登録の必要はありません。そのままレースを選んで予想してください。<br>レースを新規に登録する場合にはユーザ登録(無料)が必要になります。',
	'info_infos' => 'お知らせ',
